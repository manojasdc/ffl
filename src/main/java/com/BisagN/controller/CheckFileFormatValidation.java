...
//	public Boolean check_MP4_File(byte[] bytes) throws DecoderException {
//		byte[] mp4 = Hex.decodeHex("00000018667479706D703432");
//		byte[] mp4_file = Arrays.copyOfRange(bytes,0,4);
//		if(Arrays.equals(mp4, mp4_file)) {
//			return true;
//		}else {
//			return false;
//		}
//	}
	...
	public Boolean check_MP4_File(byte[] bytes) throws DecoderException {
		byte[] mp4 = Hex.decodeHex("00000020");
		byte[] mp4_file = Arrays.copyOfRange(bytes,0,4);
		if(Arrays.equals(mp4, mp4_file)) {
			return true;
		}else {
