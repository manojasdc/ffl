...
document.addEventListener('DOMContentLoaded', function() {
	...
	//	document.querySelectorAll('.dashname').forEach((items, index) => {
	//		items.addEventListener('click', event => {
	//
	//			var val = parseInt(index) + 1;
	//			var elements = document.getElementsByClassName("dashname");
	//
	//			var dashname = elements[index].innerText;
	//			handleButtonClick1(dashname);
	//
	//
	//
	//		});
...
//function handleButtonClick1(dashname) {
//
//	$
//		.ajax(
//			{
//				url: '../admin/dashnameData?dashname=' + dashname,
//				type: "POST",
