TotalRecordsForAddFilter = 0;
FilteredRecords = 0;
$(document).ready(function() {

	mockjax1('registrationtbl');
	dt = dataTable('registrationtbl');

	//	mockjax1('registrationtbl');
	//
	//	table = $('#registrationtbl').DataTable({
	//		serverSide: true,
	//		processing: true,
...
function loadRegistrationDetails(data, callback) {
	...
	$.ajax(
		{
			url: '../admin/LoadRegistrationData?pageno=' + startPage + '&&length=' + pageLength + "&&search=" + Search + "&&order=" + order,
			type: "POST",
