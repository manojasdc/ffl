...
<script src="layout_file/js/changepassword.js"></script>
<script type="text/javascript" src="layout_file/js/aes.js"></script>

<script type="text/javascript" src="layout_file/js/pbkdf2.js"></script>

<script type="text/javascript" src="layout_file/js/AesUtil.js"></script>
				...
				<div class="col-12 col-md-6">
					<div class="mb-3">
						...
						<input id="new_pass" type="password" maxlength="28"
							...
							autocomplete="off" required tabindex="3">
					</div>
				</div>
				...
				<div class="col-12 col-md-6">
					<div class="mb-3">
						...
						<input id="c_password" type="password" maxlength="28"
							name="c_password"
							pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%!^\\&_.~*]).{8,28}$"
							class="form-control" autocomplete="off" required tabindex="4">
					</div>
				</div>
