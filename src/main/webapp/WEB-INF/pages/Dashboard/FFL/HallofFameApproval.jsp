...
<script src="assets/dev_module_list/FFL/halloffameapproval.js"></script>
...
<div id="halloffamediv">
	<div class="content-page">
		<div class="container-fluid">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="custom-breadcrum">
						<div class="iq-members">
							<h1 class="page-title">Hall Of Fame Approval</h1>
						</div>
						<div class="page-breadcrumb">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="commonDashboard">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="demo_page">Hall Of Fame Approval</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-header">
								<div class="header-title">
									<h4 class="card-title">Hall Of Fame Approval Data </h4>
								</div>
							</div>
							<div class="card-body">
								<div class="row">
			...
			<input id="idhalloffame1" name="idhalloffame1" value="${mapid}" hidden>
