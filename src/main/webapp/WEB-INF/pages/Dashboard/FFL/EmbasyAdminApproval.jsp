...
<script src="assets/dev_module_list/FFL/EmbasyAdminApproval.js"></script>
	...
	<div class="content-page">
		<div class="container-fluid">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="custom-breadcrum">
						<div class="iq-members">
							<h1 class="page-title">Embassy Admin Approval Details</h1>
						</div>
						<div class="page-breadcrumb">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="EmbasyDashboard">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="demo_page">Embassy
										Admin Approval Details</li>
								</ol>
							</nav>
						</div>
					</div>
			...
			<section class="single-detail-block" id="kak">
				<div class="row">
					<input type="hidden" id="GeneratedKey" name="GeneratedKey"
						value="${GeneratedKey}" /> <input type="hidden" id="GeneratedIV"
						name="GeneratedIV" value="${GeneratedIV }" /> <input
						type="hidden" id="GeneratedSalt" name="GeneratedSalt"
						value="${GeneratedSalt }" /> <input type="hidden"
						...
						<div class="card">
							<div class="card-header">
								<div class="header-title">
									<h4 class="card-title">Embassy Admin Approval Details</h4>
								</div>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<table id="EmbasyAdminApprovaltbl"
