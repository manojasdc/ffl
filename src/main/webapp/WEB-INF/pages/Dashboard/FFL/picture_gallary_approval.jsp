...
<script src="assets/dev_module_list/FFL/picture_gallary_approval.js"></script>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="custom-breadcrum">
						<div class="iq-members">
							<h1 class="page-title">Picture Gallary Approval</h1>
						</div>
						<div class="page-breadcrumb">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="commonDashboard">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="demo_page">Picture Gallary Approval</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-header">
								<div class="header-title">
									<h4 class="card-title">Picture Gallary Datatable </h4>
								</div>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-12">
										<table id="photogallaryapprovaltbl"
