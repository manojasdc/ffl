			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="custom-breadcrum">
					<div class="iq-members">
						<h1 class="page-title">MISC Activities</h1>
					</div>
...
<!-- 					<a href="#" target="_blank" class="blog-image" title="View Video"> <img -->
<!-- 						class="img-fluid" src="assets/images/outerimages/banner5.jpg"> -->
<!-- 						<span class="blog-ol"> -->
...
<!-- 					<div class="blog-info"> -->
<!-- 						<div class="blog-ttl"> -->
<!-- 							<a class="blog-ttl-wraper" href="#">Passing Out Parade of -->
<!-- 								Directly Appointed Gazetted Officers Marks Success at CRPF -->
<!-- 								Academy, Gurugram</a> -->
<!-- 						</div> -->
<!-- 						<div class="blog-dtl"> -->
<!-- 							<p class="blog-auth-dtl"> -->
<!-- 								By <span class="blog-auth">Sh. Anish Dayal Singh</span><span -->
<!-- 									class="auth-passout">2023</span> -->
<!-- 							</p> -->
<!-- 							<div class="blog-desc read-more-container"> -->
<!-- 								<p class="read-more-text read-less" id="read-more-text">The -->
<!-- 									Passing Out Parade of the 54th batch of 22 Directly Appointed -->
<!-- 									Gazetted Officers (DAGOs) of the Central Reserve Police Force -->
<!-- 									(CRPF) was conducted today at the CRPF Academy, Gurugram. The -->
<!-- 									Parade was the culmination of a comprehensive 52-week arduous -->
<!-- 									training covering a wide range of subjects, including firearms -->
<!-- 									handling, law enforcement, management, human rights, VIP -->
<!-- 									security, law and order maintenance, physical fitness, unarmed -->
<!-- 									combat, field engineering, IED modules, fieldcraft, jungle -->
<!-- 									survival, operational case studies, and more.</p> -->
...
<!-- 			<div class="col-lg-6 col-md-12 col-sm-12 col-12"> -->
<!-- 				<div class="card blog-card"> -->
<!-- 					<a href="#" target="_blank" class="blog-image" title="View PDF"> <img -->
<!-- 						class="img-fluid" src="assets/images/bluegrad-bg.jpg"> <span -->
<!-- 						class="blog-ol"> <span class="pdf-block"> <span -->
<!-- 								class="pdf-icon"></span> -->
<!-- 						</span> -->
<!-- 					</span> -->
<!-- 					</a> -->
