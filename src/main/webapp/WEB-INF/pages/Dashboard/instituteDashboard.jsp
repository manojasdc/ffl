...
<script src="assets/dev_module_list/InstituteDashboard.js"></script>
<!-- Select End -->
					...
					<div class="card card-block card-stretch card-height reg-card">
						...
						<div class="card-body">
							<div class="row">
								...
								<!-- 												<h4 class="custom-dcard-title">No of Institute</h4> -->
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="iq-option custom-data-card camo-2">
										...
										<div class="media-body">
											<div class="custom-dcard-value">
												<h4 class="custom-dcard-title">No Of Countries</h4>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="iq-option custom-data-card camo-3">
										...
										<div class="media-body">
											<div class="custom-dcard-value">
												<h4 class="custom-dcard-title">No of Users</h4>
								...
								<div class="card-body custom-field-block" id="hideonyear">
									<div class="row">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-12">
											<div class="form-group"  id="yearradio">
												<input type="radio" value="registrationyear" name="year">
												<span style="color: white;">Registration Year</span> 
												<input type="radio" value="passoutyear" name="year"> 
												<span style="color: white;">Passout Year</span>
											</div>
										</div>
										
										<div class="col-lg-4 col-md-4 col-sm-12 col-12"  id="hideyear1">
											<div class="form-group">
												<label>Registration Year</label> <select id="year"
									...
									<div class="card">
										<div class="card-header">
											<div
												class="d-flex align-items-center justify-content-between">
												<div class="header-title">
													<h4 class="card-title" id="title2">Country Users Chart</h4>
												</div>
												<div class="dropdown  d-none">
													<span class="dropdown-toggle1"
														id="dropdownMenuButtontwenty" data-bs-toggle="dropdown"
									...
									<div class="card">
										<div class="card-header">
											<div
												class="d-flex align-items-center justify-content-between">
												<div class="header-title">
													<h4 class="card-title" id="title3">Users Chart</h4>
												</div>
												<div class="dropdown  d-none">
													<span class="dropdown-toggle1"
														id="dropdownMenuButtontwenty" data-bs-toggle="dropdown"
										...
										<div class="card-body custom-field-block">
											<div class="row" id="registrationchart">
												<div class="col-lg-12 col-md-12 col-sm-12 col-12">
													<div id="chartdiv5"></div>
												</div>
											</div>
											<div class="row" id="passoutchart">
												<div class="col-lg-12 col-md-12 col-sm-12 col-12">
