...
<script type="text/javascript" src="admin/layout_file/js/aes.js"></script>

<script type="text/javascript" src="admin/layout_file/js/pbkdf2.js"></script>

<script type="text/javascript" src="admin/layout_file/js/AesUtil.js"></script>
				...
				<div class="col-12 col-md-6">
					<div class="mb-3">
						...
						<input type="password" id="old_pass" name="old_pass"
							class="form-control" maxlength="28" tabindex="2"
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="mb-3">
						...
						<input id="new_pass" type="password" maxlength="28" tabindex="3"
							name="new_pass"
				...
				<div class="col-12 col-md-6">
					<div class="mb-3">
						...
						<input id="c_password" type="password" maxlength="28" tabindex="4"
							name="c_password"
							pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%!^\\&_.~*]).{8,28}$"
