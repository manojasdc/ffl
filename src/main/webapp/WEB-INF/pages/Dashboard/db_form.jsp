...
<!-- Datepicker End -->
<!-- Datagrid start -->
<!-- <link href="assets/vendor/datatable/responsive.dataTables.min.css" -->
<!-- 	rel="stylesheet" /> -->
<!-- <script src="assets/vendor/datatable/dataTables.responsive.min.js"></script> -->
<!-- <link href="assets/vendor/datatable/rowReorder.dataTables.min.css" -->
<!-- 	rel="stylesheet" /> -->
					...
					<div class="page-breadcrumb">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">DB
									Form</li>
							</ol>
						</nav>
					</div>
		...
		<div class="row">
							...
							<div class="select-dropdown">
								<div class="btn-group">
									<label data-bs-toggle="dropdown" aria-expanded="false"
										...
										class="dropdown-toggle btn-edit"><i
											class="las la-edit mr-0 text-center"></i></span> <span
										class="search-replace"></span> <span class="caret d-none">
											<!--icon-->
									</span>
									</label>
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<ul>
									<li>Current Version : <code>V3.6.4.min.js</code>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="card card-block">
					<div class="card-header">
						<div class="header-title">
							<h4 class="card-title">Graph Cards</h4>
						</div>
					</div>
					<div class="card-body">
						<div class="row">
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
						<div class="custom-graph-data">
									<div class="iq-option custom-data-card camo-1">
										...
										<div class="media-body">
											<div class="custom-dcard-value">
												...
												<h5 class="custom-dcard-count">0</h5>
											</div>
										</div>
									</div>
									<div class="custom-graph-block">
									<div class="custom-graph-filter">
									<div class="row d-flex justify-content-center">
									<div class="col-lg-10 col-md-10 col-sm-10 col-10">
										<div class="form-group">
											<select name="type" class="singleselect form-control">
												<option></option>
										...
										<div class="custom-graph">
											<img src="assets/images/amchart.png" class="img-fluid"
												alt="#">
										</div>
						...
						<div class="custom-graph-data">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-10">
										...
										<div class="custom-graph">
											<img src="assets/images/amchart.png" class="img-fluid" alt="#">
										</div>
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
									...
									<div class="custom-graph-block custom-graph-section">
									<h6 class="graph-title">Graph Title</h6>
									<div class="custom-graph-filter">
									<div class="row d-flex justify-content-center">
									<div class="col-lg-10 col-md-10 col-sm-10 col-10">
										<div class="form-group">
				...
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Disable Input<span class="mandatory">*</span></label> <input
										class="form-control" type="text" placeholder="Enter Input"
										disabled>
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group form-group-lg">
									<label>Large Input<span class="mandatory">*</span></label> <input
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group form-group-sm">
									<label>Small Input<span class="mandatory">*</span></label> <input
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Input Range<span class="mandatory">*</span></label> <input
										class="form-control" type="number" placeholder="Enter Input">
								</div>
							</div>

							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>File Upload<span class="mandatory">*</span></label> <input
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<textarea placeholder="Enter Textarea" class="form-control"></textarea>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group custom-fromgroup-select">
									<label>Default bootstrap Select<span class="mandatory">*</span></label>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group custom-fromgroup-select">
									<label>Disable Select<span class="mandatory">*</span></label> <select
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									...
									<div class="input-group select2-group select2-input-group">
										<select class="singleselect form-select"
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<h6 class="custom-card-subtitle">
									Here, below <b>"select2 plugin"</b> inputs,
								</h6>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Search with select<span class="mandatory">*</span></label>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Multi Select<span class="mandatory">*</span></label> <select
										name="type" class="multiselect2 form-control"
										multiple="multiple">
										<option></option>
										<option value="1">New List</option>
										<option value="2">Demo List</option>
				...
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Date & Time<span class="mandatory">*</span></label> <input
				...
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Valid Input<span class="mandatory">*</span></label> <input
										class="form-control valid-input" type="text"
										placeholder="Enter Input">
									<div class="note-text valid-text">
										<span class="tikClass">Kindly add custom-d-none class
											when you use this input.</span>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="form-group">
									<label>Invalid Input<span class="mandatory">*</span></label> <input
										class="form-control invalid-input" type="text"
										placeholder="Enter Input">
									<div class="note-text invalid-text">
										<span class="errorClass">Kindly add custom-d-none class
											when you use this input.</span>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<div class="form-check custom-formcheck">
									<input class="form-check-input" type="radio"
										...
										for="exampleRadios3"> Disabled radio </label>
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<p class="mb-1">
									Add
									<code class="highlighter-rouge">.modal-xl, .modal-lg &
										.modal-sm</code>
									to
									<code class="highlighter-rouge">.modal-dialog</code>
									for modal size.
								</p>
							...
							<div
								...
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-info btnsubmit">Submit</button>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<button type="button" class="btn btn-info btnsubmit">Submit</button>
								<button type="button" class="btn btn-secondary btnsubmit">Reset</button>
								...
								<button type="button" class="btn btn-danger btnupdate">Update</button>
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<h6 class="custom-card-subtitle mt-3">Rounded Outline
									Buttons</h6>
								<button type="button"
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								...
								<button type="button" class="btn btn-primary">
									<i class="ri-bill-fill"></i><span class="btn-text">Primary</span>
								</button>
								...
								<button type="button" class="btn btn-primary icon-btn" title="Like">
									<i class="ri-heart-fill"></i>
								</button>
								<button type="button" class="btn btn-secondary icon-btn" title="Star">
									<i class="ri-star-fill"></i>
								</button>
								<button type="button" class="btn btn-success icon-btn" title="Setting">
									<i class="ri-settings-4-fill"></i>
								</button>
								<button type="button" class="btn btn-danger icon-btn" title="Radio">
									<i class="ri-radio-button-fill"></i>
								</button>
								<button type="button" class="btn btn-warning icon-btn" title="Delete">
									<i class="ri-delete-bin-2-fill"></i>
								</button>
								<button type="button" class="btn btn-secondary icon-btn btnview" title="View">
									<i class="ri-eye-fill"></i>
								</button>
								<button type="button" class="btn icon-btn btnappr" title="Approve">
									<i class="ri-user-follow-fill"></i>
								</button>
								<button type="button" class="btn icon-btn btnreje" title="Reject">
									<i class="ri-user-unfollow-fill"></i>
								</button>
								<button type="button" class="btn btn-info icon-btn" title="Lock">
									<i class="ri-lock-fill"></i>
								</button>
								<button type="button" class="btn btn-light icon-btn" title="Time">
									<i class="ri-time-fill"></i>
								</button>
								<button type="button" class="btn btn-dark icon-btn" title="Light">
									<i class="ri-sun-fill"></i>
								</button>
								<button type="button" class="btn btn-link icon-btn" title="Dark">
									<i class="ri-moon-fill"></i>
								</button>
								<button type="button" class="btn btn-primary icon-btn btnedit"
									title="Edit">
									<i class="ri-edit-2-fill"></i>
								</button>
								<button type="button" class="btn btn-info icon-btn btnadd"
									title="Add">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="alert bg-light" role="alert">
									...
									<button type="button" class="close text-muted"
						...
						<div id="carouselExampleControls" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="assets/images/img-1.jpg" class="d-block w-100"
										alt="#">
								</div>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="inst_block">
									...
									<ul class="inst_list">
										<li>
											<p class="inst_text">If any of the value is not available
												or not applicable then please put it as 0</p>
										</li>
										<li>
											<p class="inst_text">Please click on 'Download templates'
												to download the templates being uploaded in applicable
												sections of the form.</p>
										</li>
										<li>
											<p class="inst_text">For uploading the required files,
												take a print on the letterhead of the Institution, and after
												getting it stamped and signed, upload the scanned copy by
												clicking at the appropriate option.</p>
										</li>
										<li>
											<p class="inst_text">
												Please click on <b class="concat-string">Module &gt; <a
													class="text-heighlight" href="">'Link'</a></b>
											</p>
										</li>
									</ul>
								</div>
								<h6 class="custom-card-subtitle">Mandatory &amp; Important
									Instruction</h6>
								<div class="inst_block simple-instruction">
									...
									support file extension .png, .jpeg, .jpg <span
										class="concat-string"> &amp; <b>Upload court order</b>
										file size upto 200kb and support file extension .pdf
									</span>
								</div>
									...
									<div class="input-style-form-check_block check-multi-list">
										<div class="form-check checkbox-style">
											...
											<input type="hidden" id="hiddenUpdate" name="hiddenUpdate"
												...
												and enrollment by the University. I also understand that my
												...
												state/central government or the hon'ble court. </label> <label
												class="check-list"> I hereby agree to abide by the
												terms and conditions or the rules pertaining to admission as
												prescribed by the competent authorities and admit that they
												are binding upon me legally and legitimately.</label> <label
												class="check-list"> I undertake to pay the fees
												fixed by the Competent Authority, University.</label> <label
												class="check-list">I undertake to see daily notices
												exhibited on the noticed board of the college, observe and
												maintain a strict discipline as the student and otherwise,
												in the college premises including hostel and campus.</label>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<ul>
									<li>We use the <code>.progress</code> as a wrapper to
										indicate the max value of the progress bar.
									</li>
									<li>We use the inner <code>.progress-bar</code> to
										indicate the progress so far.
									</li>
									<li>The <code>.progress-bar</code> requires an inline
										style, utility class, or custom CSS to set their width.
									</li>
									<li>The <code>.progress-bar</code> also requires some <code>role</code>
										and <code>aria</code> attributes to make it accessible.
									</li>
								</ul>
								<p>Put that all together, and you have the following
									examples.</p>
								<div class="progress">
								...
								<div class="progress">
									<div class="progress-bar demo-progressbar" role="progressbar"
								...
								<div class="progress">
									<div
										class="progress-bar progress-bar-striped progress-bar-animated demo-progressbar"
								...
								<div class="progress">
									<div class="progress-bar demo-progressbar" role="progressbar"
										aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
									<div class="progress-bar bg-success demo-progressbar"
										role="progressbar" aria-valuenow="25" aria-valuemin="0"
										aria-valuemax="100"></div>
									<div class="progress-bar bg-info demo-progressbar"
										role="progressbar" aria-valuenow="25" aria-valuemin="0"
										aria-valuemax="100"></div>
								</div>
							</div>
				...
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							...
							<p>
								Remove a list bullets and apply some light
								<code>margin</code>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="form-group">
														<select name="type"
															class="searchwithselect form-control custom-select">
															<option></option>
															<option value="1">New List</option>
															<option value="2">Demo List</option>
														</select>
								...
								<div class="table-responsive">
									<table class="table table-hover table-striped basic-table">
										...
										<tbody>
											<tr>
												<td class="table-block-sm">1</td>
												<td><img src="assets/images/one.png"
													class="bg-success-light rounded p-3 img-fluid avatar-70"
													alt="image"></td>
												<td>
													<h6 class="mb-2">Campaigns Name</h6> <span>Audience
														: All Contact</span>
												</td>
												<td>03 Dec , 2020</td>
												...
												<td>
													<ul class="list-inline custom-btn-group btn-group-sm">
														<li class="list-inline-item">
															<button type="button" class="btn btn-primary icon-btn btnedit" title="Edit">
																<i class="ri-edit-2-fill"></i>
															</button>
														</li>
														<li class="list-inline-item">
											...
											<tr>
												...
												<ul class="list-inline custom-btn-group btn-group-sm">
														...
														<li class="list-inline-item"><button type="button"
															...
															<li class="list-inline-item"><button type="button" class="btn btn-secondary icon-btn btnview" title="View">
									<i class="ri-eye-fill"></i>
								</button></li>
...
<!-- 													</div> -->
							...
							<div class="col-lg-3 col-md-6 col-sm-12 col-12">
								<div class="card">
									...
									<div class="card-body">
										...
										<p class="card-text">It is a long established fact that a
								...
								<div class="card text-white bg-primary">
									<div class="card-body">
										...
										<blockquote class="blockquote mb-0">
											<p class="font-size-14">Lorem ipsum dolor sit amet,
											...
											<footer class="blockquote-footer text-white font-size-12">
												Someone famous in <cite title="Source Title"
													class="text-white">Source Title</cite>
											</footer>
										</blockquote>
									</div>
								</div>
										...
										<div class="col-lg-8 col-md-6 col-sm-12 col-12">
											<div class="card-body">
												...
												<p class="card-text">This is a wider card with
													supporting text below as a natural lead-in. a little bit
													longer.</p>
												<p class="card-text">
													<small class="text-muted">Last updated 3 mins ago</small>
												</p>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="card card-block card-stretch card-height">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-nav-pillstab">
									<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
										<li class="nav-item"><a class="nav-link active"
											id="pills-home-tab" data-bs-toggle="pill" href="#pills-home"
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-nav-tabs">
									<ul class="nav nav-tabs" id="myTab-two" role="tablist">
										<li class="nav-item"><a class="nav-link active"
											id="home-tab-two" data-bs-toggle="tab" href="#home-two"
											role="tab" aria-controls="home" aria-selected="true">Home</a>
										</li>
										<li class="nav-item"><a class="nav-link"
											id="profile-tab-two" data-bs-toggle="tab" href="#profile-two"
											role="tab" aria-controls="profile" aria-selected="false">Profile</a>
										</li>
										<li class="nav-item"><a class="nav-link"
											id="contact-tab-two" data-bs-toggle="tab" href="#contact-two"
											role="tab" aria-controls="contact" aria-selected="false">Contact</a>
										</li>
									</ul>
									<div class="tab-content" id="myTabContent-1">
										<div class="tab-pane fade show active" id="home-two"
											role="tabpanel" aria-labelledby="home-tab-two">
											<p>Lorem Ipsum is simply dummy text of the printing and
												typesetting industry. Lorem Ipsum has been the industry's
												standard dummy text ever since the 1500s, when an unknown
												printer took a galley of type and scrambled it to make a
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<div class="custom-nav-pills">
									<ul class="nav nav-pills mb-3 nav-fill" id="pills-tab-1"
										role="tablist">
										<li class="nav-item"><a class="nav-link active"
											id="pills-home-tab-fill" data-bs-toggle="pill"
											href="#pills-home-fill" role="tab" aria-controls="pills-home"
											aria-selected="true">Home</a></li>
										<li class="nav-item"><a class="nav-link"
											id="pills-profile-tab-fill" data-bs-toggle="pill"
											href="#pills-profile-fill" role="tab"
											aria-controls="pills-profile" aria-selected="false">Profile</a>
										</li>
										<li class="nav-item"><a class="nav-link"
											id="pills-contact-tab-fill" data-bs-toggle="pill"
											href="#pills-contact-fill" role="tab"
											aria-controls="pills-contact" aria-selected="false">Contact</a>
										</li>
									</ul>
									<div class="tab-content" id="pills-tabContent-1">
										<div class="tab-pane fade show active" id="pills-home-fill"
											role="tabpanel" aria-labelledby="pills-home-tab-fill">
											<p>Lorem Ipsum is simply dummy text of the printing and
												typesetting industry. Lorem Ipsum has been the industry's
												standard dummy text ever since the 1500s, when an unknown
												printer took a galley of type and scrambled it to make a
										...
										<div class="tab-pane fade" id="pills-profile-fill"
											role="tabpanel" aria-labelledby="pills-profile-tab-fill">
											<p>Lorem Ipsum is simply dummy text of the printing and
												typesetting industry. Lorem Ipsum has been the industry's
												standard dummy text ever since the 1500s, when an unknown
												printer took a galley of type and scrambled it to make a
										...
										<div class="tab-pane fade" id="pills-contact-fill"
											role="tabpanel" aria-labelledby="pills-contact-tab-fill">
											<p>Lorem Ipsum is simply dummy text of the printing and
												typesetting industry. Lorem Ipsum has been the industry's
												standard dummy text ever since the 1500s, when an unknown
												printer took a galley of type and scrambled it to make a
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="card">
					...
					<div class="card-body">
						<p>Hover over the buttons below to see the four tooltips
							directions: top, right, bottom, and left. The data-placement
							attribute specifies the tooltip position.</p>

						<button type="button" class="btn btn-secondary"
							data-bs-toggle="tooltip" data-bs-placement="top"
							data-bs-title="Tooltip on top">Tooltip on top</button>
						<button type="button" class="btn btn-secondary"
							data-bs-toggle="tooltip" data-bs-placement="right"
							data-bs-title="Tooltip on right">Tooltip on right</button>
						<button type="button" class="btn btn-secondary"
							data-bs-toggle="tooltip" data-bs-placement="bottom"
							data-bs-title="Tooltip on bottom">Tooltip on bottom</button>
						<button type="button" class="btn btn-secondary"
							data-bs-toggle="tooltip" data-bs-placement="left"
							data-bs-title="Tooltip on left">Tooltip on left</button>
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="flush-headingOne">
											<button
												...
												aria-controls="flush-collapseOne">Accordion Item #1
											</button>
										</h2>
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="flush-headingTwo">
											<button
												...
												aria-controls="flush-collapseTwo">Accordion Item #2
											</button>
										</h2>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-4 col-md-4 col-sm-12 col-12">
								...
								<div class="iq-option bg-info custom-data-card">
									...
									<div class="custom-multidata-block">
										<div class="custom-mcard-value bg-skyblue-light">
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Urban Area</h4>
												<h5 class="custom-mcard-count">
													2.54<span class="custom-mcard-counttype">in Lakhs</span>
												</h5>
											</div>
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Rural Area</h4>
												<h5 class="custom-mcard-count">
													12.34<span class="custom-mcard-counttype">in Lakhs</span>
												</h5>
											</div>
										</div>
									</div>
								...
								<div class="custom-multidata-card">
									...
									<div class="custom-multidata-block">
										<div class="custom-mcard-value bg-secondary-light">
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Male</h4>
												<h5 class="custom-mcard-count">
													48.76<span class="custom-mcard-counttype">in Lakhs</span>
												</h5>
											</div>
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Female</h4>
												<h5 class="custom-mcard-count">
													46.30<span class="custom-mcard-counttype">in Lakhs</span>
												</h5>
											</div>
										</div>
									</div>
								...
								<div class="custom-multidata-card">
									...
									<div class="custom-multidata-block">
										<div class="custom-mcard-value bg-warning-light">
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Girls</h4>
												<h5 class="custom-mcard-count">
													12.73<span class="custom-mcard-counttype">in Crores</span>
												</h5>
											</div>
											<div class="mcard-value-block">
												<h4 class="custom-mcard-title">Boys</h4>
												<h5 class="custom-mcard-count">
													13.79<span class="custom-mcard-counttype">in Crores</span>
												</h5>
											</div>
										</div>
									</div>
