...
<!-- 									<div class="card card-block card-stretch card-height profile-card"> -->
...
<!-- 												<p class="dn-wrapper"><span class="dn-lbl"><i class="fa fa-envelope"></i>Email ID : </span><span class="dn-dtl">info@gmail.com</span> -->
<!-- 											</div> -->
<!-- 										</div> -->
<!-- 									</div> -->
<!-- 								</div> -->
