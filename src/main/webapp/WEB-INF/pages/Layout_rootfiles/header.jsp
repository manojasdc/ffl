...
<!-- ***** Header Area Start ***** -->
<header class="header-area header-sticky custom-header-area custom-navbararea-top">
							...
							<div class="main-nav-left">
								<div class="main-nav-ll">
									<!-- ***** logo start ***** -->
																		...
																		<a href="landing" class="logo"> <img 
																			src="admin/assets/images/outerimages/indianarmylogo.png" 
									...
									<div class="custom-header-logo">
										<a href="#" class="logo"> <img
											src="admin/assets/images/outerimages/indianarmylogo.png"
											class="img-fluid" title="National Emblem Logo"
											alt="national emblem logo">
										</a> <a href="landing" class="logo"> <img
											src="admin/assets/images/outerimages/artrac1.png"
											class="img-fluid" title="Artrack Logo" alt="Artrack logo">
										</a>
									</div>
								...
								<div class="main-nav-lr">
									<div class="custom-logo-input">
										...
										<!-- 											<span class="logo-sidetext">Friends For Life</span> -->
										<!-- 										</div> -->
								...
								<div class="main-nav-rl">
									<div class="custom-header-btn">
										<div class="main-button">
											<a href="signin" class="btn"><span class="login-text">Sign
													In</span><span class="login-icon"><i class="fa fa-user"></i></span></a>
											<a href="signup" class="btn"><span class="login-text">Sign
													Up</span><span class="login-icon"><i
					...
					<div class="custom-header-menu">
						...
						<nav>
							...
							<ul id="respMenu" class="ace-responsive-menu"
								...
								<li><a href="landing"> <span class="title"><i
								...
								<li><a href="javascript:;"> <span class="title">About
									...
									<ul>
										...
										<li><a href="objective">History</a></li>
									</ul></li>

								<li><a href="CATA"> <span class="title">Institutes</span>
								</a></li>


								<li class=""><a href="contactus"> <span class="title">Contact
											Us</span></a></li>
											<li class=""><a href="photogallery"> <span class="title">Photo Gallery</span></a></li>



								<li class="d-none"><a href="javascript:;"> <span
										class="title">Outreach</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span>
								</a>
									<ul>
										<!-- 									26-6-23 -->
								...
								<!-- 									26-6-23 -->
								<li class="d-none"><a href="javascript:;"> <span
										class="title">Achievement</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span>
								</a>
									<ul>
								...
								<li class="d-none"><a href="javascript:;"> <span
										class="title">MISC</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span>
								</a>
									<ul>
										<!-- 									26-6-23 -->
								...
								<li class="d-none"><a href="javascript:;"> <span
										class="title">Publication</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span>
								</a>
									<ul>
								...
								<li class="d-none"><a href="javascript:;"> <span
										class="title">MOUs</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span></a>
								...
								<li class="d-none"><a href="javascript:;"> <span
										class="title">Feedback</span><span class="menu-icon-right"><i
											class="fa fa-angle-down"></i></span></a>
									<ul id="feedbackList">
