		...
		<div id="heroCarousel" data-bs-interval="5000"
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active"
					style="background-image: url(admin/login_file/assets/img/slide/neet1.jpeg)">
					<div class="container">
						<div class="row">
							<div class="col-3">
								<a href="#" class="logo me-auto"><img
									src="admin/login_file/assets/img/amclogo.png" alt=""></a>
							</div>
							<div class="col-6">
								<h2>
								...
								<a class="btn-get-started scrollto" data-bs-toggle="modal"
									data-bs-target="#myModal">Login Here</a>
								<!--             <a href="registrationUrl" class="btn-get-started scrollto">Registration Here</a> -->
								<a class="btn-get-started scrollto" data-bs-toggle="modal"
									data-bs-target="#regModal">Click here to Register</a>
							</div>
							<div class="col-3">
								<a href="#" class="logo me-auto"><img
									src="admin/login_file/assets/img/amclogo.png" alt=""></a>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-6">
								...
								<!--             <a href="registrationUrl" class="btn-get-started scrollto">Registration Here</a> -->
								<a class="btn-get-started scrollto" data-bs-toggle="modal"
									data-bs-target="#regModal">Registration Here</a>
							</div>
							<div class="col-3">
								<a href="#" class="logo me-auto"><img
									src="admin/login_file/assets/img/amclogo.png" alt=""></a>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					<div class="col-lg-6" data-aos="fade-right">
						<img src="admin/login_file/assets/img/afmc.jpg" class="img-fluid"
							alt="">
					</div>
					...
					<div class="swiper-wrapper align-items-center">
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-1.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-1.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-2.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-2.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-3.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-3.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-4.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-4.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-5.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-5.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-6.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-6.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-7.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-7.jpg"
								class="img-fluid" alt=""></a>
						</div>
						<div class="swiper-slide">
							<a class="gallery-lightbox"
								href="admin/login_file/assets/img/gallery/gallery-8.jpg"><img
								src="admin/login_file/assets/img/gallery/gallery-8.jpg"
								class="img-fluid" alt=""></a>
						</div>
					</div>
					<div class="swiper-pagination"></div>
	...
	<div class="modal" id="regModal">
		<div class="modal-dialog modal-dialog-centered ">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body" style="background-color: #f7fcfc;">
					...
					<div
						...
						<div class="mb-3 mt-3">
							<button id="otpNo" name="otpNo" type="button"
								...
								onclick='return sendOTPOnEmail();' tabindex="6">Send
								OTP</button>

							<input type="text" class="form-control" id="otp"
								placeholder="enter your otp" name="otp" tabindex="7" maxlength="6">
							<!-- Time left =  -->
							<div id="timer_div">
