...
<link rel="stylesheet" href="admin/login_file/css/sweetalert.min.css">		
	<script type="text/javascript" src="admin/login_file/js/sweetalert.min.js"></script>
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item carousel-item1 active">
          <div class="container">
          <div class ="row">
          <div class ="col-sm-3 col-2"><a href="#" class="logo me-auto"><img data-src="login_file/assets/img/amclogo.png" alt="" class="lazyload"></a></div>
          <div class ="col-sm-6 col-8">         
            <h2>Welcome to <span>AFMS</span></h2>
            <p>Armed Forces Medical Services</p>
            <p class="red"><c:if test="${not empty error}">${error}</c:if></p>
			<p class="red"><c:if test="${not empty msg}">${msg}</c:if></p>
            <a class="btn-get-started scrollto" data-bs-toggle="modal" data-bs-target="#myModal">Login Here</a>
            <a class="btn-get-started scrollto" data-bs-toggle="modal" data-bs-target="#regModal">Registration Here</a>
<!--             <button type="button" class="btn-get-started scrollto" data-bs-toggle="modal" data-bs-target="#myModal">Login Here</button> -->
        ...
        <div class="carousel-item carousel-item2">
          ...
          <div class ="col-sm-6 col-8">         
            ...
            <p class="red"><c:if test="${not empty error}">${error}</c:if></p>
			<p class="red"><c:if test="${not empty msg}">${msg}</c:if></p>
            <a href="" class="btn-get-started scrollto" data-bs-toggle="modal" data-bs-target="#myModal">Login Here</a>
            <a href="registrationUrl" class="btn-get-started scrollto">Registration Here</a>
          </div>
          <div class ="col-sm-3 col-2"><a href="#" class="logo me-auto"><img data-src="login_file/assets/img/amclogo.png" alt="" class="lazyload"></a></div>
          </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-1.jpg"><img data-src="login_file/assets/img/gallery/gallery-1.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-2.jpg"><img data-src="login_file/assets/img/gallery/gallery-2.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-3.jpg"><img data-src="login_file/assets/img/gallery/gallery-3.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-4.jpg"><img data-src="login_file/assets/img/gallery/gallery-4.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-5.jpg"><img data-src="login_file/assets/img/gallery/gallery-5.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-6.jpg"><img data-src="login_file/assets/img/gallery/gallery-6.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-7.jpg"><img data-src="login_file/assets/img/gallery/gallery-7.jpg" class="img-fluid lazyload" alt=""></a></div>
            <div class="swiper-slide"><a class="gallery-lightbox" href="login_file/assets/img/gallery/gallery-8.jpg"><img data-src="login_file/assets/img/gallery/gallery-8.jpg" class="img-fluid lazyload" alt=""></a></div>
          </div>
        ...
        <div class="row mt-5">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Room No 234 - South Block, Ministry of Defence,
                  <br/> New Delhi.
                    </p>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="button" class="btn-get-started scrollto">Send Message</button></div>
            </form>
          </div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div
						...
						<div class="mb-3 mt-3">
							<label for="sel1" class="form-label">Select Branch</label> <select
						...
						<div class="mb-3 mt-3">
							<label for="email">Name </label> <input type="textbox"
								class="form-control" id=nameforreg placeholder="Enter your Name"
								name="emailforreg" maxlength="128" tabindex="2" autocomplete="off">
						</div>
						<div class="mb-3 mt-3">
						...
						<div class="mb-3 mt-3">
							<label for="email">Neet Registration No. </label> <input
								type="textbox" class="form-control" id=neetregno
						...
						<div class="mb-3 mt-3">
							<button id="otpNo" name="otpNo" type="button"
								...
								onclick='return sendOTPOnEmail();' tabindex="6" autocomplete="off">Send
								OTP</button>

							<input type="text" class="form-control" id="otp"
								placeholder="enter your otp" name="otp" tabindex="7" maxlength="6" autocomplete="off">
							<!-- Time left =  -->
							<div id="timer_div">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn btn-success"
						onclick="return VerifyOTPandRegister()" id="verifyandregister"
						name="verifyandregister" tabindex="8">Verify and Register</button>
				</div>
